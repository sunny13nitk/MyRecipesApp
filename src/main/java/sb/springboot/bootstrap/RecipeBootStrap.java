package sb.springboot.bootstrap;
...
import sb.springboot.repository.CategoryRepository;
...
public class RecipeBootStrap implements ApplicationListener<ContextRefreshedEvent>
{
	...
	public RecipeBootStrap(
	        ...
	        sb.springboot.repository.UOMRepository uOMRepository, IngredientRepository ingredientRepository
	)
	{
		super();
	...
	/*
	 * Load the Recipes in RecipeRepository using Repository saveAll Method Since Recipe Repository is a bean; It can be
	 * influenced in this Method (non-Javadoc)
	 * @see
	...
	)
	{
		...
		tacosRecipe.setDifficulty(Difficulty.DIFFICULT);
